...
export const FilesModule = observer(() => {
  ...
  return (
    <>
      ...
      {fileList.length > 0 && (
        <Box sx={{ display: 'flex', justifyContent: 'space-between', marginBottom: 2, marginX: 2 }}>
      ...
      {view === 'Grid' ? (
        <Grid container gap={4} sx={{ width: '100%', paddingX: 2 }} justifyContent="center">
          {fileList.map((file) => (
            <Grid sx={{ width: '100%' }} item key={file._id} xl={2} lg={3} md={4} sm={6} xs={12}>
